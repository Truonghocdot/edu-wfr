        ...
        <div class="report-container">
            ...
            <section class="report-card">
                <div class="card-top">
                    ...
                    <h2 class="card-title">Lost Item - I lost something</h2>
                </div>

                <form class="form-grid" action="{{ route('storeLostItem') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf

                    @if ($errors->any())
                        <div
                            style="grid-column: 1/-1; background: #fee; padding: 10px; border-radius: 4px; color: #c33;">
                    ...
                    @endif
                    <div class="left-col">
                        <label class="field-label" for="title">Item Name<span class="req">*</span></label>
                        <input id="title" name="title" type="text" placeholder="e.g., iPhone 6, Backpack, Book"
                        ...
                        <textarea id="description" name="description" rows="3" placeholder="Provide a detailed description" required>{{ old('description') }}</textarea>

                        <label class="field-label" for="location">Location<span class="req">*</span> (Where did you
                            lose
                            it?)</label>
                        <input id="location" name="location" type="text" placeholder="e.g., Library, Cafeteria"
                            required value="{{ old('location') }}" />

                        <label class="field-label" for="date_reported">Date<span class="req">*</span> (When did
                            you lose it?)</label>
                        <input id="date_reported" name="date_reported" type="date" required
                    ...
                    <div class="right-col">
                        <div class="field-block">
                            ...
                            <label class="upload-area">
                                <input id="image" name="image" type="file" accept=".png,.jpg,.jpeg,.gif"
                                    hidden />
                                <span><b class="linkish">Upload a photo</b> or drag and
                                    drop</span>
                        ...
                        <label class="checkbox">
                            ...
                            <span>Post anonymously (your name won't be shown publicly)</span>
                        </label>
