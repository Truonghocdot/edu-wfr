...
<body>
    ...
    <main class="lost-hero">
        <div class="lost-container">
            ...
            <form action="{{ route('foundItems') }}" method="GET" class="filters-panel">
                ...
                <div class="filter select">
                    <!-- Location filter could be added similarly if needed, for now placeholder to match UI style or remove -->
                    <div class="pill">
            ...
            <p class="results-hint">Showing {{ $items->count() }} of {{ $items->total() }} found items</p>
                    ...
                    <article class="item-card">
                        ...
                        <div class="content">
                            ...
                            <div class="details">
                                ...
                                <div>Found on {{ $item->date_reported->format('d/m/Y') }}</div>
                                <div>By {{ $item->user->name }}</div>
                            </div>
                            <div class="actions">
                                <a href="{{ route('viewFoundItem', $item->id) }}" class="view-btn">
